    ...
    <MainLayout>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert">
          <p className="text-lg">
            Spinny Wheel is a versatile random selection wheel designed to help you make decisions in a fun, 
          ...
          <p>
            Spinny Wheel began as a simple project to bring fun and fairness to decision-making. 
          ...
          <p>
            Spinny Wheel is primarily a web application that works seamlessly on both desktop and mobile browsers. 
          ...
          <p>
            We're constantly working on improving Spinny Wheel. Our roadmap includes developing native 
          ...
          <p>
            We'd love to hear your feedback or answer any questions you might have about Spinny Wheel. 
